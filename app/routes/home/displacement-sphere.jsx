...
export const DisplacementSphere = props => {
  ...
  useEffect(() => {
    ...
    startTransition(() => {
      geometry.current = new SphereGeometry(8, 128, 128);
  ...
  useEffect(() => {
    const dirLight = new DirectionalLight(0xffffff, theme === 'light' ? 1.8 : 3.0);
    const ambientLight = new AmbientLight(0xffffff, theme === 'light' ? 2.7 : 1.2);
  ...
  useEffect(() => {
    ...
    if (width <= media.mobile) {
      sphere.current.position.x = 5;
      sphere.current.position.y = 2;
